(function () {
  ...
  function renderDirector() {
    ...
    app.innerHTML = [
      ...
      '<section class="director-section"><p class="section-eyebrow">Party-day phone protocol</p><h2>Prepare, operate, recover</h2>',
      '<div class="director-operation__body">',
      '<div><h3>Before starting</h3>' + list(director.phoneProtocol.before) + "</div>",
      '<div><h3>During the adventure</h3>' + list(director.phoneProtocol.during) + "</div>",
      '<div><h3>Recovery guidance</h3>' + list(director.phoneProtocol.recovery) + "</div>",
      "</div></section>",
